...
if args['d'] == None and args['f'] == None:
	...
	if args['d'] != None:
		for jsDir in args['d']:
			#preprocess1Dir = PreprocessingJsData.dicoOfAllNGrams(args['p'], jsDir, args['l'][i], args['n']); # args = parser, JsDirectory, n
	...
	if args['f'] != None:
		for jsFile in args['f']:
			...
			if dico is not None:
				...
				#allNGrams[2] += args['l'][2]; # Contains the label of the well-formed JS files.
