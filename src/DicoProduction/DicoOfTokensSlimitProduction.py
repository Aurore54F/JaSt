...
# List of tokens available here <https://github.com/rspivak/slimit/blob/master/src/slimit/lextab.py>
#augmented with some future reserved words.
...
tokensDico = { \n"
    ConfFileProduction.dicoStorage(currentPath+'/Dico_MapTokens-Int', \
								'DicoOfTokensSlimit2.py', descr, orderedDico)
